  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="max-w-2xl w-full bg-white p-8 overflow-y-auto border-t-8 border-blue-500">
        ...
        <div className="mb-6">
          <p className="text-gray-600 mb-2">Scan the QR Code with any UPI App and pay the amount.</p>
          <div className="flex flex-col items-center">
            <img src="" alt="QR CODE" className="get_qr h-52 w-52 border border-gray-300 bg-gray-100 mb-4" />
            <img src="https://st1.techlusive.in/wp-content/uploads/2023/03/UPI-apps.jpg" className="w-full max-w-sm" alt="UPI Apps" />
          </div>
        </div>

        <div className="mb-6">
          <label htmlFor="upiReference" className="block mb-2">Enter 12-digit UPI Reference ID**</label>
          <input
            type="text"
            id="upiReference"
